                    ...
                    <form role="form" action="{{ route('app-settings.update') }}" method="post" id="quickForm"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <x-form.form-group-label-input div_class="col-sm-3" label_for="home_toolbar_message"
                                    lable_class="required" label_name="Home Toolbar Message" input_type="text"
                                    input_name="home_toolbar_message" input_id="home_toolbar_message" input_style=""
                                    input_class="" input_value="{{ $message->data['home_toolbar_message'] }}"
                                    input_placeholder="Home Toolbar Message" />
                                <x-form.form-group-label-input div_class="col-sm-3" label_for="message"
                                    lable_class="required" label_name="Message" input_type="text" input_name="message"
                                    input_id="message" input_style="" input_class=""
                                    input_value="{{ $message->data['message'] }}" input_placeholder="Message" />
